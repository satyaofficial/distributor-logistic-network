...
<html>
    ...
    <body>
        <center>
            ...
            <div style="width: 950px; height: 200px;"></div>
            <form name="" action="DAgentOrderConf.jsp" method="get">
                <table width="600px">
                    <tr>
                        <td width="200px" style="text-align:left;">&nbsp</td>
                        <td width="100px" style="text-align:center;">Sale Agent Id&nbsp;:</td>
                    ...
                    <tr>
                        ...
                        <td width="300px" style="text-align:left;">&nbsp;<input type="submit" style="color:White;background-color:#E55D05;border-color:#E55D05;border-style:None;"  value="submit" ></td>
                    </tr>
                </table>
            </form>
